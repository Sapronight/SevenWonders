class Army {
  ...
  toString() {
    const text = `La troupe ${this.name_}: HP ${this.hp_}, LifeTime ${
      this.timeLife_
    }, Mode ${this.mode_}, qui coûte: ${this.price_}`;
    console.log(text);
  }
  ...
  combat(otherArmy) {
    ...
    console.log(
      `Le résultat du combat ${this.name_} contre ${otherArmy.name_} est :`
    );
    console.log(
      `${this.name_}: HP = ${this.hp_} et ${otherArmy.name_}: HP = ${
        otherArmy.hp_
      }`
    );
